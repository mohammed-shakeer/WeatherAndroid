...
public class WeatherDetailsFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        ((TextView)view.findViewById(R.id.textViewTemp)).setText(Utils.tempValue(item.getMain().getTemp(), ((MainActivity)getActivity()).isCelsius));
        ...
        ((TextView)view.findViewById(R.id.textViewTempRange)).setText(Utils.tempRangeValue(item.getMain().getMinTemp(), item.getMain().getMaxTemp(), ((MainActivity)getActivity()).isCelsius));
